...
import { Loader2, RefreshCcw, WineOff } from "lucide-react"
...
const Page = () => {
  ...
  //optimistic UI
  const handleDeleteMessage = (messagedId: string)=>{
    setMessages(messages.filter((message)=> message._id!== messagedId))
  }
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      <h1 className="text-4xl font-bold mb-4">{
        `${username.charAt(0).toUpperCase() + username.slice(1)}'s Dashboard`
        }</h1>
